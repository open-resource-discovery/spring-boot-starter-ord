...
class EntityTypeDefinitionGeneratorTest {
  ...
  private EntityAutoGenerator<Ord.EntityTypeDefinition, EntityTypeDefinition> classUnderTest;
  ...
  public void verifyAnnotationPropertiesCount() {
    assertEquals(6, Ord.EntityTypeDefinition.class.getDeclaredMethods().length);
  }

  @Test
  void givenThatTypeIsMissing_whenGenerateIsCalled_thenExceptionIsThrown() {
    Ord.EntityTypeDefinition annotation = Annotations.mock(

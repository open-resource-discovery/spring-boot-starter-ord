...
public class AnnotationProcessorFactoryImpl implements AnnotationProcessorFactory {
  ...
  public static AnnotationProcessorFactoryBuilder builder(AutowireCapableBeanFactory autowireCapableBeanFactory) {
    return new AnnotationProcessorFactoryBuilder() {
      private AutowireCapableBeanFactory autowireCapableBeanFactory;
      private Map<Class<? extends Annotation>, Supplier<AnnotationProcessor<? extends Annotation, ?>>> suppliers =
          new HashMap<>(DEFAULT_SUPPLIERS);

      @Override
      public AnnotationProcessorFactoryBuilder withAutowireCapableBeanFactory(
      ...
      @Override
      public AnnotationProcessorFactoryBuilder withSuppliers(
          Map<Class<? extends Annotation>, Supplier<AnnotationProcessor<? extends Annotation, ?>>>
              suppliers) {
      ...
      @Override
      public AnnotationProcessorFactoryBuilder withSupplier(
      ...
      @Override
      public AnnotationProcessorFactory build() {
        return new AnnotationProcessorFactoryImpl(autowireCapableBeanFactory, suppliers);
      }
    }.withAutowireCapableBeanFactory(autowireCapableBeanFactory);
  }

  private static final Map<Class<? extends Annotation>, Supplier<AnnotationProcessor<? extends Annotation, ?>>>
      DEFAULT_SUPPLIERS = Map.ofEntries(

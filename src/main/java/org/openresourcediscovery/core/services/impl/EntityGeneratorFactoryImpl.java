...
public class EntityGeneratorFactoryImpl implements EntityGeneratorFactory {
  ...
  public EntityGeneratorFactoryImpl(AutowireCapableBeanFactory autowireCapableBeanFactory) {
  ...
  private static Map<Class<? extends Annotation>, Supplier<EntityGenerator<? extends Annotation, ?>>>
      instantiateSuppliers() {
    return Map.ofEntries(
        entry(
            Ord.AccessStrategy.class,
            () -> new EntityAutoGenerator<Ord.AccessStrategy, AccessStrategy>(AccessStrategy::new)),
        entry(Ord.Agent.class, AgentGenerator::new),
        entry(
            Ord.ApiCompatibility.class,
            () -> new EntityAutoGenerator<Ord.ApiCompatibility, ApiCompatibility>(ApiCompatibility::new)),
        entry(
        ...
        entry(
            ...
            () -> new EntityAutoGenerator<Ord.ApiResourceIntegrationAspect, ApiResourceIntegrationAspect>(
        ...
        entry(
            ...
            () -> new EntityAutoGenerator<Ord.CapabilityIntegrationAspect, CapabilityIntegrationAspect>(
                CapabilityIntegrationAspect::new)),
        entry(
            Ord.ChangelogEntry.class,
            () -> new EntityAutoGenerator<Ord.ChangelogEntry, ChangelogEntry>(ChangelogEntry::new)),
        entry(Ord.ConsumptionBundle.class, ConsumptionBundleGenerator::new),
        entry(
            Ord.ConsumptionBundleReference.class,
            () -> new EntityAutoGenerator<Ord.ConsumptionBundleReference, ConsumptionBundleReference>(
                ConsumptionBundleReference::new)),
        entry(
            Ord.CredentialExchangeStrategy.class,
            () -> new EntityAutoGenerator<Ord.CredentialExchangeStrategy, CredentialExchangeStrategy>(
        ...
        entry(
            ...
            () -> new EntityAutoGenerator<Ord.DataProductLink, DataProductLink>(DataProductLink::new)),
        entry(
        ...
        entry(
            ...
            () -> new EntityAutoGenerator<
                Ord.EventResourceIntegrationAspectSubset, EventResourceIntegrationAspectSubset>(
                EventResourceIntegrationAspectSubset::new)),
        entry(
            Ord.ExposedApiResourcesTarget.class,
            () -> new EntityAutoGenerator<Ord.ExposedApiResourcesTarget, ExposedApiResourcesTarget>(
        ...
        entry(Ord.Tombstone.class, () -> new EntityAutoGenerator<Ord.Tombstone, Tombstone>(Tombstone::new)),
